...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-[#020617] text-slate-100 flex flex-col justify-center items-center px-4 font-sans selection:bg-blue-500 selection:text-white relative overflow-hidden">
      {/* Background Accent Gradients */}
      <div className="absolute top-1/4 -left-40 w-[30rem] h-[30rem] bg-blue-600/10 rounded-full blur-[120px] pointer-events-none"></div>
      <div className="absolute bottom-1/4 -right-40 w-[30rem] h-[30rem] bg-violet-600/10 rounded-full blur-[120px] pointer-events-none"></div>

      <div className="max-w-md w-full glass-card rounded-2xl p-8 shadow-2xl relative z-10 space-y-6">
        <div className="text-center space-y-2">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-blue-600 via-indigo-600 to-violet-600 mx-auto flex items-center justify-center font-black text-white text-xl shadow-lg shadow-blue-500/25">
            GP
          </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full bg-slate-950/80 px-4 py-3 rounded-xl border border-slate-800 text-slate-100 placeholder-slate-500 text-sm focus:outline-none focus:border-blue-500/50 font-mono"
              disabled={isLoading}
              autoFocus
            />
          </div>
          ...
          <button
            ...
            className="w-full py-3 rounded-xl btn-primary font-bold text-sm transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer flex items-center justify-center gap-2"
          >
            {isLoading ? (
              <>
        ...
        <div className="pt-4 border-t border-slate-800 text-center space-y-2">
          ...
          <div className="flex justify-center gap-2 font-mono">
            <button
              ...
              className="text-xs px-3 py-1.5 rounded-lg bg-slate-950 hover:bg-slate-900 border border-slate-800 text-slate-300 transition-colors cursor-pointer"
            >
              @octocat
            </button>
            <button
